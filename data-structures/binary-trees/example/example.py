...
system("clear")
print("\nDeleting values 8, 25, 30 and 5 from BS Tree...")
print("\nBinary Search Tree diagram before deletion:\n")
bst.print_tree_diagram()
print("\nBinary Search Tree diagram after deletion:\n")
bst.delete(8)
bst.delete(25)
bst.delete(30)
bst.delete(5)
...
system("clear")
print("\nDeleting values 8, 25, 19 and 4 from AVL Tree...")
print("\nAVL Tree diagram before deletion:\n")
avlt.print_tree_diagram()
print("\nAVL Tree diagram after deletion:\n")
avlt.delete(8)
avlt.delete(25)
avlt.delete(19)
avlt.delete(4)
