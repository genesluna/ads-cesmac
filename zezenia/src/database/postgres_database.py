"""
This script defines functions to save Zezenia game data to a Postgres database
...
data to a Postgres database table with the given name.
- save_monsters_to_database(dataframe): saves a Pandas DataFrame of monster data
 to an Postgres database.
...
The script also sets up a Postgres connection to the database and defines the necessary
...
def save_loot_to_database(dataframe: pd.DataFrame, table_name: str) -> None:
    """
    Save a Pandas DataFrame of loot data to a Postgress database table with the given name.
...
def save_monsters_to_database(dataframe: pd.DataFrame) -> None:
    """
    Saves a dataframe containing monster data to an Postgress database.
