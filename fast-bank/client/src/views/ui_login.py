...
class Ui_Login(object):
    def setupUi(self, Login):
        ...
        self.logo.setPixmap(QPixmap(u"./src/assets/images/logo.png"))
        ...
        self.label.setPixmap(QPixmap(u"./src/assets/images/logo_cesmac.png"))
    ...
    def retranslateUi(self, Login):
        ...
        self.txt_pasword.setPlaceholderText(
