...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setPixmap(QPixmap(u"./src/assets/images/logo.png"))
        ...
        self.btn_home.setStyleSheet(u"QPushButton {\n"
                                    ...
                                    "}")
        icon = QIcon()
        icon.addFile(u"./src/assets/images/home.png",
        ...
        self.btn_deposit.setStyleSheet(u"QPushButton {\n"
                                       ...
                                       "}")
        icon1 = QIcon()
        icon1.addFile(u"./src/assets/images/deposit.png",
                      QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.btn_withdraw.setStyleSheet(u"QPushButton {\n"
                                        ...
                                        "}")
        icon2 = QIcon()
        icon2.addFile(u"./src/assets/images/withdraw.png",
                      QSize(), QIcon.Normal, QIcon.Off)
